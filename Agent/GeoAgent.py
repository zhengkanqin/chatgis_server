...
tools = [draw_boundary,draw_circle,draw_label,draw_geojson,draw_image,read_file,geo_data_convert,attribute_query,buffer_query,buffer_query,Query_GeoFile,map_reverse_geocode,spatial_query]
